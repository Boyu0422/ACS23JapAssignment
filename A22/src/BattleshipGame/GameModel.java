...
public class GameModel {
     ...
     * Purpose: set the values on the array of game data and array of configuration data to zero
     * Algorithm: no
     * */
     ...
     * @param isPlayer - the boolean value indicates whether the target is machine or human player
     * */
     ...
     * Algorithm: Validating the legibility of the user selected position and then generate the ship
     * @param size - the size of a ship
     * @param row - the position of row of a user selected ship
     * @param col - the position of col of a user selected ship
     * @param isVertical - the boolean indicates if the direction of the ship is vertical
    ...
    public void generateOneShip(int size, int row, int col, boolean isVertical, GameView gameView, int[] remains) {
        ...
        if (remains[size - 1] == 0) {
            JOptionPane.showMessageDialog(gameView.designModeDialog, "No Ship Remains", "Sorry, there is no ship remains, please try another size of ship!", JOptionPane.ERROR_MESSAGE);
            return;
        }
        ...
        if (isVertical) {
            ...
            if (row + size - 1 > gameDimension * 2 - 1) {
                JOptionPane.showMessageDialog(gameView.designModeDialog, "Ship Placement Error", "Sorry, you can't place the ship at that place, please try again!", JOptionPane.ERROR_MESSAGE);
                return;
            }
